...
Reader._pdefine = function (name, read) {
    Reader.prototype[name] = _.partial(_read, name, read);
};

Reader.prototype.define = function (name, read) {
    this[name] = _.bind(_read, this, name, read);
};
