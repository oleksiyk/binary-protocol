...
exports.define('raw', {
    ...
    write: function (buffer) {
        if(this.offset + buffer.length > this.buffer.length){
            throw new RangeError('Trying to access beyond buffer length');
        }
...
exports.define('Int64BE', {
    read: function () {
        var l = new Long.fromBits(this.buffer.readInt32BE(this.offset + 4), this.buffer.readInt32BE(this.offset));
        this.offset += 8;
        return l;
    },
    write: function (value) {
...
exports.define('Int64LE', {
    read: function () {
        var l = new Long.fromBits(this.buffer.readInt32LE(this.offset), this.buffer.readInt32LE(this.offset + 4));
        this.offset += 8;
        return l;
    },
    write: function (value) {
